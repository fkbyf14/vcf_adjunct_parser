...
from vcf_adjunct_parser import __version__, VCFAdjunctParser
...
def print_version(ctx, param, value):
    ...
    if not value or ctx.resilient_parsing:
        return
    click.echo('vcf_adjunct_parser version: ' + __version__)
    ctx.exit()
...
def cli(variant_file, vep, split, outfile, verbose, silent, check_info,
    ...
    """
    from vcf_adjunct_parser import logger, init_log
